...
export default async function ProjectTimeline() {
    ...
    return (
        <Timeline position="right" sx={{ alignSelf: "center", '& .MuiTimelineItem-root': { minHeight: 'auto', '&::before': { display: 'none' } } }}>
            {projects.map((project, index) => (
                <TimelineItem key={project.id}>
                    <TimelineOppositeContent sx={{ alignItems: 'center', display: 'flex', flex: "0 0 auto", p: 0, mr: 2 }}>
